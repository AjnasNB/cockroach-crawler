...
const assets = [
  {
    ...
    height: 640,
    motif: "composite",
    eyebrow: "OPEN-SOURCE CRAWL CONTROL",
    headline: ["Crawling with", "a boundary."],
    subhead: "Hardened local crawling, a restricted serverless tier, and read-only source adapters.",
    chips: ["DNS-pinned local path", "explicit budgets", "normalized records"],
  ...
  },
  {
    ...
    subhead: "Run one local doctor command before a workflow touches the public web or a provider API.",
    chips: ["Web", "GitHub", "YouTube", "X API", "Reddit API"],
    hook: "No cookie scraping. Missing credentials stay visible.",
  },
  {
  ...
  },
  {
    ...
    headline: ["Give agents reach—", "with boundaries."],
  ...
  },
  {
    ...
    headline: ["Crawl wider.", "Stay bounded."],
    subhead: "Put hard limits around every discovery path.",
  ...
  },
  {
    ...
    headline: ["Reach that names", "its boundary."],
  ...
  },
  {
    ...
    subhead: "A policy-aware crawl path for public pages plus read-only adapters for GitHub, YouTube, X, and Reddit.",
    chips: ["hardened local tier", "restricted serverless tier", "source doctor", "normalized records"],
    hook: "Open source • Node.js • MIT",
  },
];
...
function doctorArt() {
  const cards = [
    ...
    ["YOUTUBE", "OEMBED / API", palette.cyan],
    ["X API", "BEARER REQUIRED", palette.amber],
    ["REDDIT API", "OAUTH REQUIRED", palette.amber],
  ];
