...
The `0.3.0-alpha.3` prerelease adds a capability-aware registry, ordered source routing, and optional read-only reach providers. Check the installed package version before importing it.
