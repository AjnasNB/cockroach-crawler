...
The stable `0.5.2` package includes the capability-aware registry, ordered source routing, and optional read-only reach providers. Check the installed package version before importing it.
