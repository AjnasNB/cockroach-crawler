...
- `cockroach-crawler@0.7.0-rc.1` resolves from npm `next`, matches the reviewed artifact and provenance, and is explicitly called a prerelease;
...
npx -y --package cockroach-crawler@0.7.0-rc.1 cockroach-crawl https://example.com \
