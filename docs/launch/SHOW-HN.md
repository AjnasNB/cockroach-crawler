...
- `cockroach-crawler@0.5.1` resolves from npm `latest` and matches the reviewed GitHub tag;
...
npx -y --package cockroach-crawler@0.5.1 cockroach-crawl https://example.com \
