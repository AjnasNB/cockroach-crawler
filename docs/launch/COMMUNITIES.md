...
The product lesson behind Cockroach Crawler `0.5.0` was that public URLs, provider APIs, logged-in read sessions, browser actions, and serverless fetches are not one capability. Each has a different setup, failure mode, and trust boundary.
