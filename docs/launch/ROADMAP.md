...
This roadmap is evidence-driven. Dates start from the stable `0.5.0` release on 2026-07-21. Items may move when provider APIs, security findings, or contributor capacity change. “Done” means the stated exit criteria are met, not that code merely exists on a branch.
