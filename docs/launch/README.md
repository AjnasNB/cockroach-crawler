# Cockroach Crawler 0.5.0 launch kit
...
1. Verify the npm `0.5.0` artifact and matching GitHub tag.
...
The current npm and website release is stable `0.5.0`. Do not reuse prerelease wording from older screenshots or drafts.
