...
Cockroach Crawler `0.5.0` takes the opposite approach. It exposes two crawler tiers, returns their capabilities, and keeps official and optional read-only source providers separate from both.
...
```bash
npm install --global cockroach-crawler@0.5.0
