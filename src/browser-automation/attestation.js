...
export function normalizeBackendResult(value, action, maximumOutputBytes) {
  ...
  const attestationRaw = exactRecord(
    raw.attestation,
    new Set(["action", "effect", "origin", "sessionBound", "withinBudget", "fileRefsAccepted", "artifact"]),
    new Set(["action", "effect", "origin", "sessionBound", "withinBudget"]),
