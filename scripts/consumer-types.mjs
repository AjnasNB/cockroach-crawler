...
import {
  ...
  type BrowserAutomationCapabilityReport
...
automation.capabilityReport() satisfies BrowserAutomationCapabilityReport;
browserAutomationCapabilityReport().puppeteerApiCompatible satisfies false;
void automation;
