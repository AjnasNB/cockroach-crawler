  ...
  return `
    <section class="hero shell">
      <div class="hero-copy">
        ...
        <div class="candidate-note"><span>Evidence gate</span><p>The candidate is pinned to <strong>${candidateCommit.slice(0, 7)}</strong>. The report DOI is reserved; the final numerical release claim remains blocked because the frozen evaluation did not pass every gate.</p></div>
      </div>
  ...
  return `
    <article class="paper-page">
      <header class="paper-hero shell">
        ...
        <dl class="paper-facts"><div><dt>Status</dt><dd>Release-candidate manuscript</dd></div><div><dt>Stable package</dt><dd>${publishedVersion}</dd></div><div><dt>Candidate source</dt><dd>${candidateCommit.slice(0, 12)}</dd></div><div><dt>DOI</dt><dd><a href="${paperDoiUrl}">${paperDoi}</a> · reserved</dd></div></dl>
      </header>
