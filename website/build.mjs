...
const pages = [
  ...
  },
  {
    ...
    description: "Stable Cockroach Crawler 0.7.0 observed-development benchmark: 0.894101 precision, 0.926022 recall, and 0.890524 macro F1 on 511 WCEB pages.",
    body: benchmarkPage(),
