...
function footer() {
  return `
    <footer class="site-footer">
      ...
      <div class="shell legal"><span>MIT · npm stable 0.2.0 · npm next 0.3.0-alpha.2</span><span>Site content last reviewed 20 July 2026</span></div>
    </footer>`;
}
  ...
  return `
    <section class="hero shell">
      <div class="hero-copy">
        ...
        <div class="candidate-note"><span>Published prerelease</span><p><strong>0.3.0-alpha.2</strong> adds tested provider and serverless contracts under the npm <code>next</code> tag. Stable users remain on 0.2.0.</p></div>
      </div>
    ...
    <section class="section shell faq-section"><div><p class="eyebrow">Questions answered plainly</p><h2>Know the limits before installing.</h2></div><div class="faq-list">
      ...
      <details><summary>Can it read GitHub, YouTube, X, or Reddit?</summary><p>The npm-stable 0.2.0 package has no provider registry. The published 0.3.0-alpha.2 prerelease adds public GitHub REST, YouTube metadata, keyed YouTube search, official X API v2 bearer access, and Reddit application-only OAuth. YouTube transcripts are not implemented.</p></details>
      <details><summary>Can I run it in a serverless edge function?</summary><p>The published 0.3.0-alpha.2 prerelease includes a self-hosted, token-authenticated, rate-limited Cloudflare Worker profile for deployment-configured HTTPS origins. It is bounded, but it does not resolve, classify, or pin DNS answers; an allowlisted hostname can resolve internally. Use operator-owned or independently trusted hostnames plus infrastructure egress policy. Stable users remain on 0.2.0.</p></details>
    </div></section>`;
}
...
function providersPage() {
  return `
    ...
    <section class="section shell"><div class="table-wrap" tabindex="0" role="region" aria-label="Provider capability status table"><table class="status-table"><thead><tr><th>Surface</th><th>npm stable 0.2.0</th><th>npm next 0.3.0-alpha.2</th><th>Boundary</th></tr></thead><tbody>
