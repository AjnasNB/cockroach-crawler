...
const wceb = JSON.parse(await readFile(path.join(root, "bench/results/wceb-test-0.5.2.json"), "utf8"));
...
assert.equal(wceb.package.version, "0.5.2");
...
const conformance = JSON.parse(await readFile(path.join(root, "bench/results/public-conformance-0.5.2.json"), "utf8"));
...
assert.equal(conformance.package.version, "0.5.2");
