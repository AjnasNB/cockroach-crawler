...
```sh
npm run bench:public:wceb -- --dataset ../wceb --split test --output bench/results/wceb-test-0.5.2.json
```
...
```sh
npm run bench:public:conformance -- --output bench/results/public-conformance-0.5.2.json
```
